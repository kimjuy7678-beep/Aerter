    ...
    >
      ...
      <div className="absolute left-[7%] bottom-[12%] md:bottom-[10%] max-w-[340px] w-[44vw] md:w-[280px] lg:w-[330px]">
        ...
        <div>
          ...
          <p className="font-pretendard text-[14px] font-normal text-foreground mb-3">
            차일드피치
          </p>
          <p className="font-pretendard text-[11px] font-light text-foreground leading-relaxed mb-4">
